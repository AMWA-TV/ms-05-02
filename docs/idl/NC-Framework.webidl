...
$macro(Block)
	...
	[control-class("1.1",1)] interface ncBlock : ncObject {
		[element("2p1")]  attribute	 ncBoolean					enabled;			// TRUE iff block is functional
		[element("2p2")]  attribute	 ncString 					userLabel;			// user-settable label 			
		[element("2p3")]  readonly attribute	 ncString		specId;				// Global ID of blockSpec that defines this block
		[element("2p4")]  readonly attribute	 ncVersionCode	specVersion;		// Version code of blockSpec that defines this block
		[element("2p3")]  readonly attribute	 ncString		parentSpecId;		// Global ID of parent of blockSpec that defines this block
		[element("2p4")]  readonly attribute	 ncVersionCode	parentSpecVersion;	// Version code of parent of blockSpec that defines this block
		[element("2p5")]  readonly attribute	 ncString		specDescription;	// Description of blockSpec that defines this block
		[element("2p6")]  readonly attribute	 ncBoolean		isDynamic;			// TRUE iff dynamic block
		[element("2p7")]  readonly attribute	 ncBoolean		isModified;			// TRUE iff block contents modified since last reset
		[element("2p8")]  attribute	sequence<ncOid> 			members; 			// OIDs of this block's members 
		[element("2p9")]  attribute	sequence<ncPort>			ports;				// this block's ports
		[element("2p10")] attribute	sequence<ncSignalPath>		signalPaths; 		// this block's signal paths  
...
$macro(WorkflowDataCore)
	...
	[control-class("1.6",1)] interface WorkflowDataRecord : ncAgent {
